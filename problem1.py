...
The result should be with two decimal place.To get two decimal place refer the belowmentioned print statement :
float cost=670.23;
...
fuel = 20
distance = 150
fuel1 = float(20/150)*100 #fuel per 100km
print(round(fuel1,2))
distance1= float(150*0.6214) 
fuel2 = float(20*0.2642)
gallon = float(distance1/fuel2)
print(round(gallon,2))